## 코드 모듈명
나중에 어? 이거 했었는데 어떤거에 있더라... 라고 하고 있는 나의 모습이 보여서 참고용으로 작성 (latest 2022.02.04)
...
|모듈명|내용|
|:---:|---|
|ex2421|액티비티가 실행될 때 네트워크 상태를 파악해서 상태를 출력하는 예제|
|ex2441|Retrofit을 이용해 서버에서 받아온 데이터를 리스트뷰로 출력하는 예제|
|ex2451|서버에서 이미지를 받아서 출력, 로딩이나 에러 상황이면 로딩, 에러 이미지가 출력되는 예제|

**25강**

|모듈명|내용|
|:---:|---|
|ex2521|뷰를 획득할 때 뷰 바인딩 기법을 이용하는 예제|

**26강**

|모듈명|내용|
|:---:|---|
|ex2611|액티비티에서 클릭하는 버튼에 따라 다른 프래그먼트 출력(프래그먼트 동적 실행)|
|ex2621|리사이클러뷰 적용 예제|
